	...
	await describe('--columns argument', async () => {
		await test('should return with outdated dependency message and all available columns', ['--columns', 'name,current,wanted,latest,type,location,packageType,changes,changesPreferLocal,homepage,npmjs'], mockData.defaultResponse, (command, exitCode, stdout) => {
			...
			expect('`stdout` should contain the correct output', () => assert.equal(
				stdout.replace(/\x20+(\n|$)/gu, '$1'),
				[
					'32 outdated dependencies found:',
					'',
					...
					'\u001b[33mmodule-without-properties\u001b[39m                                  \u001b[90munknown\u001b[39m        \u001b[32m\u001b[39m               \u001b[35m\u001b[39m              node_modules/module-without-properties                                                        https://www.npmjs.com/package/module-without-properties                             https://www.npmjs.com/package/module-without-properties                             https://www.npmjs.com/package/module-without-properties                             https://www.npmjs.com/package/module-without-properties',
